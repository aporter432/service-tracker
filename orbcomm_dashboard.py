...
def notification_detail(notif_id):
    ...
    if pair_row:
        ...
        other_id = pair_dict['resolved_notification_id'] if notification['status'] == 'Open' else pair_dict['open_notification_id']
        if other_id:
...
def export_csv():
    ...
    fieldnames = [
        ...
        'duration', 'affected_services', 'summary', 'time_to_resolve_minutes'
    ]
